...
const InvestigacionNormativa = () => {
  const [selectedTab, setSelectedTab] = useState('resumen');

  const features = [
    { icon: '🔎', title: 'Buscador Inteligente', desc: 'CFF, LISR, LIVA, LIEPS, etc.' },
    { icon: '📰', title: 'Reformas Fiscales', desc: 'Interpretación de cambios normativos' },
    { icon: '🔄', title: 'Comparador Normativo', desc: 'Antes vs Después en leyes' },
    { icon: '⚖️', title: 'Jurisprudencia SAT', desc: 'Criterios y sentencias' },
    { icon: '🌍', title: 'Tratados Internacionales', desc: 'Impuestos y convenios' },
  ];
    ...
    <div style={{ padding: '30px', background: '#0f172a', minHeight: '100vh', color: '#e5e7eb' }}>
      ...
      <div style={{ marginBottom: '30px' }}>
        ...
        <p style={{ fontSize: '16px', color: '#9ca3af', marginBottom: '20px' }}>
          Acceso completo a toda la legislación fiscal mexicana
        </p>
        <div style={{ 
          background: '#1a2332', 
          padding: '15px 20px', 
          ...
          💰 Rentabilidad Media-Alta - Especialistas y grandes empresas
        </div>
      </div>
      ...
      {selectedTab === 'resumen' && (
        <div style={{ background: '#1a2332', padding: '25px', borderRadius: '12px', border: '1px solid #2d3e52' }}>
          <h2 style={{ color: '#60a5fa', marginBottom: '15px', fontSize: '20px' }}>¿Qué es Investigación Normativa?</h2>
          <p style={{ marginBottom: '15px', lineHeight: '1.8', textAlign: 'justify' }}>
            Tu referencia legal completa. Busca artículos específicos, entiende reformas recientes, consulta jurisprudencia 
            y expande tu conocimiento sobre tratados internacionales fiscales.
          </p>
          <div style={{ background: '#0f172a', padding: '15px', borderRadius: '8px', marginTop: '20px' }}>
            ...
            <ul style={{ listStyle: 'none', padding: 0 }}>
              <li style={{ marginBottom: '8px' }}>✅ Consultas de legislación específica</li>
              <li style={{ marginBottom: '8px' }}>✅ Análisis de reformas fiscales</li>
              <li style={{ marginBottom: '8px' }}>✅ Investigación de criterios SAT</li>
              <li style={{ marginBottom: '8px' }}>✅ Asesoría en operaciones internacionales</li>
            </ul>
          </div>
        </div>
      )}
...
export default InvestigacionNormativa;
